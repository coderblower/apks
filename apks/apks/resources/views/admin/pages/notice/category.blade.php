...
@section('title','Report Category Management')
@section('content')
<div class="content pt-5">
    <div class="mx-n6 bg-white px-6 pt-7 border-y border-300">
        <div class="row">
            <h3>Report Category  Management</h3>
            <div class="col-md-4">
                {{-- @if(!isset($getReportCat)) --}}
                <form action="{{ route('admin.notice.cat.store') }}" method="POST">
                    @csrf
                ...
                <tbody class="list" id="table-latest-review-body">
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap" style="min-width:360px;">
                      <h6 class="fw-semi-bold mb-0">{{ $item->cat_name }}</h6>
                    </td>
                      ...
                      <div class="font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2">
                          ...
                          {{-- <a class="dropdown-item text-danger" href="{{ route('admin.team-member.destroy', $item->id) }}">Remove</a> --}}
                            <a class="dropdown-item text-danger" onclick="return confirm('Are You Sure? This Action Can Not be Undone.')" href="{{ route('admin.notice.cat.delete',$item->id) }}">Delete </a>
                        </div>
                      </div>
                    </td>
                  </tr>
