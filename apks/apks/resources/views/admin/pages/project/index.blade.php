            ...
            <div class="row align-items-end justify-content-between pb-5 g-3">
              ...
              <div class="col-12 col-md-auto">
                <div class="row g-2">
                  ...
                  <div class="col-auto">
                      <a href="{{ route('admin.project.category.index') }}" class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100" type="a">Project Categories</a>
                  </div>
                  <div class="col-auto">
                      <a href="{{ route('admin.project.create') }}" class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100" type="a">Create New Project</a>
              ...
              <table class="table fs--2 mb-0 overflow-hidden">
                <thead>
                  <tr>
                    ...
                    <th class="sort border-top white-space-nowrap align-middle" scope="col" style="min-width:220px;">Category</th>
                ...
                <tbody class="list" id="table-latest-review-body">
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap" style="min-width:360px;">
                      <h6 class="fw-semi-bold mb-0">{{ $item->project_title }}</h6>
                    </td>
                    <td class="align-middle white-space-nowrap" style="min-width:220px;">
                      <h6 class="fw-semi-bold mb-0">{{ optional($item->category)->category_name ?: 'Uncategorized' }}</h6>
                    </td>
                  
                    <td class="align-middle customer white-space-nowrap" style="min-width:200px;">
                      <div class="d-flex align-items-center">
                        <div class="">
                          <div class="avatar-name "><span><img style="object-fit: cover;" width="100" src="{{ asset('apks/public/uploads/projects/'.$item->project_logo) }}" alt=""></span></div>
                        </div>
                    ...
                    <td class="align-middle white-space-nowrap text-end pe-0">
                      ...
                      <div class="font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2">
                          <a class="dropdown-item" href="{{ route('admin.project.edit', $item->id) }}">Edit</a>
                          <a class="dropdown-item" href="{{ route('admin.project.status', $item->id) }}">Change status</a>
                          {{-- <a class="dropdown-item text-danger" href="{{ route('admin.team-member.destroy', $item->id) }}">Remove</a> --}}
                            <a class="dropdown-item text-danger" onclick="return confirm('Are You Sure? This Action Can Not be Undone.')" href="{{ route('admin.project.delete',$item->id) }}">Delete </a>
                        </div>
                      </div>
                    </td>
                  </tr>
