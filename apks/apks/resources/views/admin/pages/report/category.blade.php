    ...
    <div class="mx-n6 bg-white px-6 pt-7 border-y border-300">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form action="{{ route('admin.report.cat.store') }}" method="POST">
                    @csrf
                      ...
                      <div class="font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2">
                          ...
                          {{-- <a class="dropdown-item text-danger" href="{{ route('admin.team-member.destroy', $item->id) }}">Remove</a> --}}
                            <a class="dropdown-item text-danger" onclick="return confirm('Are You Sure? This Action Can Not be Undone.')" href="{{ route('admin.report.cat.delete',$item->id) }}">Delete </a>
                        </div>
                      </div>
                    </td>
                  </tr>
