...
<div class="content pt-5">
    ...
    <div class="mx-n6 bg-white px-6 pt-5 py-5 border-y border-300">
        <div class="row">
            <h3 class="mb-5">Add A New Team Member</h3>
            ...
            <form action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12 position-relative">
                    ...
                    <input class="form-control" name="name" placeholder="Enter Full Name" id="validationTooltip01" required="">
                </div>
                <div class="col-md-12 position-relative">
                    <label class="form-label" for="validationTooltip02"> Deignation *</label> 
                    <input class="form-control" name="designation" placeholder="Enter Designation" id="validationTooltip02" required="">
                </div>
                <div class="col-md-12 position-relative">
                    <label class="form-label" for="validationTooltip03"> Facebook Profile link</label> 
                    <input class="form-control" name="fb" placeholder="Facebook Profile URL" id="validationTooltip03" >
                </div>
                <div class="col-md-12 position-relative">
                    <label class="form-label" for="validationTooltip05"> Twitter Profile Link</label> 
                    <input class="form-control" name="twitter" placeholder="Enter Twitter Profile Link" id="validationTooltip05" >
                </div>
                <div class="col-md-12 position-relative">
                    <label class="form-label" for="validationTooltip06"> Instagram Profile Link</label> 
                    <input class="form-control" name="instagram" placeholder="Enter Instagram Profile Link" id="validationTooltip06">
                </div>
                <div class="col-md-12 position-relative">
