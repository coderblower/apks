            ...
            <div class="row align-items-end justify-content-between pb-5 g-3">
              ...
              <div class="col-12 col-md-auto">
                <div class="row g-2">
                  ...
                  <div class="col-auto">
                      <a href="{{ route('admin.team.create') }}" class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100" type="a">Add New Team Member</a>
              ...
              <table class="table fs--2 mb-0 overflow-hidden">
                <thead>
                  <tr>
                    ...
                    <th class="sort border-top align-middle" scope="col" data-sort="customer" style="min-width:200px;"> Designation</th>
                    <th class="sort border-top align-middle" scope="col" data-sort="customer" style="min-width:200px;"> Type</th>
                ...
                <tbody class="list" id="table-latest-review-body">
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap" style="min-width:360px;">
                      <h6 class="fw-semi-bold mb-0">{{ $item->member_name }}</h6>
                    </td>
                    <td class="align-middle product white-space-nowrap" style="min-width:360px;">
                        <h6 class="fw-semi-bold mb-0">{{ $item->member_designation }}</h6>
                      </td>
                    <td class="align-middle product white-space-nowrap" style="min-width:360px;">
                        <h6 class="fw-semi-bold mb-0">{{ $item->member_board_access }}</h6>
                      </td>
                    <td class="align-middle customer white-space-nowrap" style="min-width:200px;">
                      <div class="d-flex align-items-center">
                        <div class="">
                          <div class="avatar-name "><span><img style="object-fit: cover;" width="100" src="{{ asset('apks/public/uploads/team/'.$item->member_photo) }}" alt=""></span></div>
                        </div>
                    ...
                    <td class="align-middle white-space-nowrap text-end pe-0">
                      ...
                      <div class="font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2">
                          <a class="dropdown-item" href="{{ route('admin.team.edit', $item->id) }}">Edit</a>
                          <a class="dropdown-item" href="{{ route('admin.team.status', $item->id) }}">Change status</a>
                          {{-- <a class="dropdown-item text-danger" href="{{ route('admin.team-member.destroy', $item->id) }}">Remove</a> --}}
                            <a class="dropdown-item text-danger" onclick="return confirm('Are You Sure? This Action Can Not be Undone.')" href="{{ route('admin.team.delete',$item->id) }}">Delete </a>
                        </div>
                      </div>
                    </td>
                  </tr>
