            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column" id="navbarVerticalNav">
               ...
               {{-- Team Links --}}
                ...
                <ul class="nav collapse parent {{ (request()->is('admin-panel/activity/programme') || request()->is('admin-panel/activity/programme/create') || request()->is('admin-panel/activity/project/create') || request()->is('admin-panel/activity/project') || request()->is('admin-panel/activity/event/create') || request()->is('admin-panel/activity/event') ? 'show':'') }}" id="activity">
                  <li class="nav-item ">
