...
@section('title','Messsage Collection')
@section('content')
<div class="content pt-5">
    <div class="mx-n6 bg-white px-6 pt-7 border-y border-300">
        <div class="row">
            <h3>Message From Contact Page</h3>
              ...
              <table class="table fs--2 mb-0 overflow-hidden">
                <thead>
                  <tr>
                      ...
                      <th class="sort border-top white-space-nowrap align-middle" scope="col" style="min-width:150px;" data-sort="product">Name</th>
                    <th class="sort border-top white-space-nowrap align-middle" scope="col" style="min-width:150px;" data-sort="product">Email Address</th>
                    <th class="sort border-top white-space-nowrap align-middle" scope="col" style="min-width:150px;" data-sort="product">Phone</th>
                    <th class="sort border-top white-space-nowrap align-middle" scope="col" style="min-width:360px;" data-sort="product">Message</th>
                    <th class="sort border-top white-space-nowrap align-middle" scope="col" style="min-width:60px;" data-sort="product">Action</th>
                ...
                <tbody class="list" id="table-latest-review-body">
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap" style="min-width:150px;">
                      <h6 class="fw-semi-bold mb-0">{{ $item->first_name.' '.$item->last_name }}</h6>
                    </td>
                    <td class="align-middle product white-space-nowrap" style="min-width:150px;">
                    ...
                    <td class="align-middle product white-space-nowrap" style="min-width:60px;">
                      <h6 class="fw-semi-bold mb-0"><a href="mailto:{{ $item->email }}" class="btn btn-info btn-sm">Send Reply</a></h6>
                    </td>
