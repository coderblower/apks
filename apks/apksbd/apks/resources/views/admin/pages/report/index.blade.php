              ...
              <table class="table fs--2 mb-0 overflow-hidden">
                ...
                <tbody class="list" id="table-latest-review-body">
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap" style="min-width:200px;">
                      <h6 class="fw-semi-bold mb-0">{{ $item->report_category }}</h6>
                    </td>
                    ...
                    <td class="align-middle white-space-nowrap text-end pe-0">
                      ...
                      <div class="font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2">
                            <a class="dropdown-item text-danger" href="{{ route('admin.report.status',$item->id) }}">Change Status </a>
                          {{-- <a class="dropdown-item text-danger" href="{{ route('admin.team-member.destroy', $item->id) }}">Remove</a> --}}
                            <a class="dropdown-item text-danger" onclick="return confirm('Are You Sure? This Action Can Not be Undone.')" href="{{ route('admin.report.delete',$item->id) }}">Delete </a>
                        </div>
                      </div>
                    </td>
                  </tr>
